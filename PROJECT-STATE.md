...
> **⏹ FROZEN 2026-08-22.** Work stopped 2026-05-10 at commit `5a6b49b`. This document was reconciled against the git log and working tree on 2026-08-22 and is accurate as of that date; nothing maintains it afterward. See `HANDOFF/` for the successor lines.
...
- **SVG layer authoring (panels-first).** The actual bottleneck, and where work stopped. [Corrected 2026-08-22: **32 exported SVGs across 41 piece folders**; 28 pieces are in the connection graph. The anchor, pendulum and bob clusters are done; a partial motor-wheel set (033–049) has Affinity sources but no exports.] Authored across the anchor / pendulum / bob clusters (065-072 + 093a/093b + 094-100 + 110) plus scattered framework and mechanism pieces (001, 002, 037, 038, 041, 044, 045, 047, 058, 059, 090, 113); next pulls in the gear train per the brief at `claude-work/to-alan/gear-train/` (covers §II.B motor/middle/escape + §II.D reduction-gear/hands; 087 reduction-gear disc currently on the bench). Conventions stable post-DECISIONS #7; LAYER-CONVENTIONS.md is the live reference. Per-piece sidecars now carry `function` (mechanism geometry), `connections.inferred[]` (learned cross-piece edges, DECISIONS #10), and `assembled.folds` (per-fold assembled angles, DECISIONS #11) blocks.
- **`preview.html` iteration.** Three substantive ships piled on through May 2026: PR #17 multi-piece scene assembly, PR #18 inferred-connections audit-side merge, PR #19 assembled-pose load + save. [Corrected 2026-08-22: the architecture decision **closed on 2026-05-07** as Option B — `preview.html` is permanent, `claude-work/viewer/` is built fresh at M3, `work/viewer/` will never be populated. Seven further ships followed through 2026-05-10: marks-lookup, bridge button, Cluster mode, snap, bridge save, guided stepper, grouped fold sliders, closure derive.] v1b end-to-end verification quietly closed in the panels-first batch; cutouts subtraction (0.6.10) and multi-cutaway slabs (0.6.11) remain not-started but unblocked.
